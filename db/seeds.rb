...
listing_one = Listing.create(name: "Rhein-Energie Stadion", address: "Cologne", user_id: 1, price: 200_000, description: "The Rhein Energie stadium, located in Cologne, Germany, exudes a vibrant aura with its modern architecture, passionate FC Köln fanbase, and an electrifying atmosphere that amplifies the intensity of matches, making it a true fortress and source of pride for the club and its supporters.", capacity: 50_000)
...
listing_two = Listing.create(name: "Allianz Arena", address: "Munich, Germany", user_id: 1, price: 200_000, description: "The Allianz Arena, located in Munich, Germany, is a magnificent state-of-the-art football stadium renowned for its iconic translucent exterior facade that can change colors, symbolizing the home teams of FC Bayern Munich, creating a mesmerizing spectacle during matches and serving as a symbol of the city's passion for the beautiful game.", capacity: 75_000)
...
listing_four = Listing.create(name: "Anfield", address: "Liverpool, England", user_id: 1, price: 50_000, description: "Anfield stadium, located in Liverpool, England, is an illustrious and hallowed football ground, resonating with the echoes of rich history, passionate chants, and the unwavering spirit of Liverpool FC's devoted supporters, creating an incomparable atmosphere that captures the essence of the club's legendary legacy.", capacity: 52_000)
listing_four.photos.attach(io: file, filename: "anfield.png", content_type: "image/png")
listing_four.save!

file = URI.open("https://res.cloudinary.com/dridrfy9y/image/upload/v1685503208/dpkysxlfgovsp8bdt73g.jpg")
listing_five = Listing.create(name: "Camp Nou", address: "Barcelona, Spain", user_id: 1, price: 20_000, description: "Camp Nou, situated in Barcelona, Spain, stands as an imposing cathedral of football, renowned for its colossal size, captivating architecture, and the roaring symphony of FC Barcelona fans that fills its stands, embodying the club's essence and captivating spectators with its grandeur.  ", capacity: 95_000)
...
listing_eight = Listing.create(name: "San Siro", address: "Milan, Italy", user_id: 1, price: 27_000, description: "The San Siro, located in Milan, Italy, stands as a timeless football cathedral, hosting the passionate rivalries of AC Milan and Inter Milan, as well as countless historic moments, with its iconic structure and electrifying atmosphere etching indelible memories into the hearts of football enthusiasts worldwide.", capacity: 82_000)
