...
listing_two = Listing.create(name: "Allianz Arena", address: "Munich", user_id: 1, price: 200_000, description: "The Allianz Arena, located in Munich, Germany, is a magnificent state-of-the-art football stadium renowned for its iconic translucent exterior facade that can change colors, symbolizing the home teams of FC Bayern Munich, creating a mesmerizing spectacle during matches and serving as a symbol of the city's passion for the beautiful game.", capacity: 75_000)
...
listing_eight = Listing.create(name: "San Siro", address: "Milan", user_id: 1, price: 27_000, description: "The San Siro, located in Milan, Italy, stands as a timeless football cathedral, hosting the passionate rivalries of AC Milan and Inter Milan, as well as countless historic moments, with its iconic structure and electrifying atmosphere etching indelible memories into the hearts of football enthusiasts worldwide.", capacity: 82_000)
...
listing_nine = Listing.create(name: "Stamford Bridge", address: "London", user_id: 1, price: 150_000, description: "
